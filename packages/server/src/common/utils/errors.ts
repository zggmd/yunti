// import { RoleVerb } from '@/platform-role/models/role-verb.enum';
...
/**
 * 仅用于未登录的报错，前端收到这个报错后会提示用户重新登录
 *
 * @export
 * @class LoginRequiredException
 * @extends {Error}
 */
export class LoginRequiredException extends Error {
  extensions: ErrorExtensions;
  ...
  constructor(message: string, rawArgs: any = {}) {
    ...
    this.extensions.code = 'LoginRequired';
  }
}
