...
export class PersistentVolumeClaim {
   ...
   * @param {K8s.V1PersistentVolumeClaim} body PersistentVolumeClaim 对象
  ...
  create(
    ...
    const { pretty, dryRun, fieldManager, fieldValidation, headers } =
      options || {};
    return this.k8sApi.createNamespacedPersistentVolumeClaim(
      namespace,
      body,
      pretty,
      dryRun,
   ...
   *
   * @param {string} name PersistentVolumeClaim 名称
   * @param {string} namespace 命名空间
   * @param {K8s.V1PersistentVolumeClaim} body PersistentVolumeClaim 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  replace(
    ...
    const { pretty, dryRun, fieldManager, fieldValidation, headers } =
      options || {};
    return this.k8sApi.replaceNamespacedPersistentVolumeClaim(
      name,
      namespace,
      body,
      pretty,
  ...
  /**
   * 部分更新指定的 PersistentVolumeClaim (JSON Patch)
   *
   * @param {string} name PersistentVolumeClaim 名称
   * @param {string} namespace 命名空间
   * @param {JsonPatchOp[]} body PersistentVolumeClaim 对象
  ...
  patch(
    ...
    const { pretty, dryRun, fieldManager, fieldValidation, force, headers } =
      options || {};
    return this.k8sApi.patchNamespacedPersistentVolumeClaim(
      name,
      namespace,
      body,
      pretty,
  ...
  /**
   * 部分更新指定的 PersistentVolumeClaim (Merge Patch)
   *
   * @param {string} name PersistentVolumeClaim 名称
   * @param {string} namespace 命名空间
   * @param {object} body PersistentVolumeClaim 对象
   * @param {PatchOptions} [options] 可选配置项
   */
  patchMerge(
    name: string,
  ...
  /**
   * 部分更新指定的 PersistentVolumeClaim (Strategic Merge Patch)
   *
   * @param {string} name PersistentVolumeClaim 名称
   * @param {string} namespace 命名空间
   * @param {object} body PersistentVolumeClaim 对象
  ...
  /**
   * 根据名称删除一个 PersistentVolumeClaim
   *
   * @param {string} name PersistentVolumeClaim 名称
   * @param {string} namespace 命名空间
  ...
  delete(name: string, namespace: string, options?: DeleteOptions) {
    ...
    return this.k8sApi.deleteNamespacedPersistentVolumeClaim(
      name,
      namespace,
      pretty,
      dryRun,
  ...
  // <remove is="Service">
  /**
   * 根据选择器删除多个 PersistentVolumeClaim
   *
   * @param {string} namespace 命名空间
  ...
  deleteCollection(
    ...
    return this.k8sApi.deleteCollectionNamespacedPersistentVolumeClaim(
      namespace,
      pretty,
      _continue,
      dryRun,
  ...
  /**
   * 根据名称获取 PersistentVolumeClaim 详情 (指定 namespace 下)
   *
   * @param {string} namespace 命名空间
  ...
  read(name: string, namespace: string, options?: ReadOptions) {
    ...
    return this.k8sApi.readNamespacedPersistentVolumeClaim(
      name,
      namespace,
      pretty,
      { headers },
  ...
  list(namespace: string, options?: ListOptions) {
    ...
    return this.k8sApi.listNamespacedPersistentVolumeClaim(
      namespace,
      pretty,
      allowWatchBookmarks,
      _continue,
  ...
  /**
   * 列取 PersistentVolumeClaim 列表 (所有 namespace 下)
   *
   * @param {ListOptions} [options] 可选配置项
   */
  listAll(options?: ListOptions) {
    ...
    return this.k8sApi.listPersistentVolumeClaimForAllNamespaces(
      allowWatchBookmarks,
      _continue,
      fieldSelector,
      labelSelector,
